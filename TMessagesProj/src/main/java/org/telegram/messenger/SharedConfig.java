...
//    public static int saveToGalleryFlags;
    ...
    public static class ProxyInfo {
        ...
        public static ProxyInfo fromUrl(String url) {
            ProxySettings parsedSettings = ProxySettings.fromUri(Uri.parse(url));
            if (parsedSettings == null) throw new IllegalArgumentException(url);
            return new ProxyInfo(parsedSettings);
        }
    }
