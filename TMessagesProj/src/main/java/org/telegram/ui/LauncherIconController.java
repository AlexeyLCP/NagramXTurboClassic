...
public class LauncherIconController {
    ...
    public enum LauncherIcon {
        ...
        GLASS("GlassIcon", R.drawable.ic_glass_background, R.drawable.ic_glass_foreground, R.string.AppIconGlass, R.drawable.ic_notification_glass, null, 0, 0),
        ...
        COMIX_BLUE("ComixBlueIcon", R.drawable.ic_comix_blue_background, R.drawable.ic_comix_blue_foreground, R.string.AppIconComixBlue, R.drawable.ic_notification_comix_blue, null, 0, 0),
        COMIX_PURPLE("ComixPurpleIcon", R.drawable.ic_comix_purple_background, R.drawable.ic_comix_purple_foreground, R.string.AppIconComixPurple, R.drawable.ic_notification_comix_purple, null, 0, 0),
